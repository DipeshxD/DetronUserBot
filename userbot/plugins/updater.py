...
BOT_IS_UP_TO_DATE = "**The DETRONBOT** is up-to-date sur."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your ELITES BOT ..."
)
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "Uᴘᴅᴀᴛᴇᴅ Yᴏᴜʀ DetronBᴏᴛ Is Sᴜᴄᴄᴇssғᴜʟʟʏ. Aғᴛᴇʀ 5-7 Mɪɴᴜᴛᴇs Tʏᴘᴇ (.ping or .alive) Tᴏ Cʜᴇᴄᴋ I ᴀᴍ Aʟɪᴠᴇ Oʀ ɴᴏᴛ🚶😏"
    )
